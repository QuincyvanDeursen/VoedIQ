...
@Component({
  selector: 'app-afvallen-module1-lesson2',
  imports: [QuizQuestionComponent, InfoBlockComponent, CommonModule],
  templateUrl: './afvallen-module1-lesson2.component.html',
  styleUrl: './afvallen-module1-lesson2.component.css',
})
export class AfvallenModule1Lesson2Component {
