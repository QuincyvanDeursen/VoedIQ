...
import questions from '../../../../../assets/data/quiz/quiz_afvallen.json';

@Component({
  selector: 'app-afvallen-introductie',
  imports: [QuizComponent],
  templateUrl: './afvallen-introductie.component.html',
  styleUrl: './afvallen-introductie.component.css',
})
export class AfvallenIntroductieComponent {
