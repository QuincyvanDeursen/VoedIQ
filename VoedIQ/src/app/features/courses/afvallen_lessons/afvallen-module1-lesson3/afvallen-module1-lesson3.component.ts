...
@Component({
  selector: 'app-afvallen-module1-lesson3',
  imports: [QuizQuestionComponent, InfoBlockComponent],
  templateUrl: './afvallen-module1-lesson3.component.html',
  styleUrl: './afvallen-module1-lesson3.component.css',
})
export class AfvallenModule1Lesson3Component {
  crashdieetVraag = {
    question:
