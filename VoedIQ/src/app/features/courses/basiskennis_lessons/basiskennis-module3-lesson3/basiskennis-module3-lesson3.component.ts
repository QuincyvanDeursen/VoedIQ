...
@Component({
  selector: 'app-basiskennis-module3-lesson3',
  imports: [QuizQuestionComponent, InfoBlockComponent],
  templateUrl: './basiskennis-module3-lesson3.component.html',
  styleUrl: './basiskennis-module3-lesson3.component.css',
})
export class BasiskennisModule3Lesson3Component {
  afvallenVraag = {
    question:
