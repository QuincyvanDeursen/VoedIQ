...
@Component({
  selector: 'app-basiskennis-module4-lesson1',
  imports: [InfoBlockComponent, QuizQuestionComponent],
  templateUrl: './basiskennis-module4-lesson1.component.html',
  styleUrl: './basiskennis-module4-lesson1.component.css',
})
export class BasiskennisModule4Lesson1Component {
