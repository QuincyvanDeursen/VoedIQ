...
@Component({
  selector: 'app-basiskennis-module2-lesson3',
  imports: [QuizQuestionComponent, InfoBlockComponent],
  templateUrl: './basiskennis-module2-lesson3.component.html',
  styleUrl: './basiskennis-module2-lesson3.component.css',
})
export class BasiskennisModule2Lesson3Component {
  waterVraag = {
    question:
