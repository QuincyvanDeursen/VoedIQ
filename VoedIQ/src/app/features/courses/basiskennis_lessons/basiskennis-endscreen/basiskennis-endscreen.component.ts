...
@Component({
  selector: 'app-basiskennis-endscreen',
  imports: [QuizComponent, RouterLink],
  templateUrl: './basiskennis-endscreen.component.html',
  styleUrl: './basiskennis-endscreen.component.css',
})
export class BasiskennisEndscreenComponent {
