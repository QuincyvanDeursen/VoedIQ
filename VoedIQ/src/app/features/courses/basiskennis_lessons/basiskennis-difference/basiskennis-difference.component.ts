...
@Component({
  selector: 'app-basiskennis-difference',
  imports: [QuizQuestionComponent, InfoBlockComponent],
  templateUrl: './basiskennis-difference.component.html',
  styleUrl: './basiskennis-difference.component.css',
})
export class BasiskennisDifferenceComponent {
  voedingsvraag = {
