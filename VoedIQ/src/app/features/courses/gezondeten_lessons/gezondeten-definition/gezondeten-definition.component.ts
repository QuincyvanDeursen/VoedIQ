...
@Component({
  selector: 'app-gezondeten-definition',
  imports: [QuizQuestionComponent, InfoBlockComponent, CommonModule],
  templateUrl: './gezondeten-definition.component.html',
  styleUrl: './gezondeten-definition.component.css',
})
export class GezondetenDefinitionComponent {
